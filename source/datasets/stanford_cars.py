...
class StanfordCars(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        self.split_fewshot_dir = os.path.join(os.getcwd(), "datasets/splits/stanford_cars")
        ...
        train, val, test = OxfordPets.fix_image_paths([train, val, test], "stanford_cars", root)
